...
A quick start Blazor project that shows how to create a Word document and add text, image, and table to it using the [.NET Word (DocIO) Library](https://www.syncfusion.com/document-sdk/net-word-library).
