# How to Create a Word Document in Blazor using Blazor Word (DocIO) Library

A quick start Blazor project that shows how to create a Word document and add text, image, and table to it using the Syncfusion [Blazor Word (DocIO) Library](https://www.syncfusion.com/document-processing/word-framework/blazor/word-library?utm_source=github&utm_medium=listing&utm_campaign=github-docio-examples).
...
- **Product page:** [Syncfusion Word Framework](https://www.syncfusion.com/document-processing/word-framework/blazor?utm_source=github&utm_medium=listing&utm_campaign=github-docio-examples)
- **Documentation:** [Create a Word document](https://help.syncfusion.com/file-formats/docio/create-word-document-in-blazor?utm_source=github&utm_medium=listing&utm_campaign=github-docio-examples)
...
- **Online demo:** [Syncfusion Word library - Online demos](https://blazor.syncfusion.com/demos/word/hello-world?theme=fluent?utm_source=github&utm_medium=listing&utm_campaign=github-docio-examples)
